...
public extension ViewDSL {
    ...
    /// - Returns: View instance of closure parameter type
    @discardableResult
    func add<T>(_ closure: (T) -> Void) -> T where T: View {
        let view = T()
        put(view)
        closure(view)
        return view
    ...
    /// Base DSL
    ///
    /// - Parameter closure: function to build View instance
    /// - Returns: View instance of closure return type
    @discardableResult
    func add<T>(_ closure: () -> T) -> T where T: View {
        let view = closure()
        put(view)
        return view
    }
    ...
    @discardableResult
    func add<T>(_ view: T, closure: ((T) -> Void)? = nil) -> T where T: View {
        put(view)
        defer { closure?(view) }
        return view
    }
